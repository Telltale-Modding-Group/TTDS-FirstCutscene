...
Custom_CutsceneDev_Freecam_InputFieldOfViewAmount = 90;
...
--user configruable
Custom_CutsceneDev_Freecam_SnappyMovement = false;
Custom_CutsceneDev_Freecam_SnappyRotation = false;
Custom_CutsceneDev_Freecam_PositionLerpFactor = 5.0;
Custom_CutsceneDev_Freecam_RotationLerpFactor = 7.5;
Custom_CutsceneDev_Freecam_PositionIncrementDefault = 0.025;
